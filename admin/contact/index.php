                ...
                <ul>
                    ...
                    <li class="menu-dropdown open">
                        ...
                        <ul class="dropdown-sidebar">
                            ...
                            <li class="active"><a href="../contact/index.php">Contact list</a></li>
                                ...
                                <table class="table ">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td scope="row"><?php echo substr($data['msg'], 0, 100); ?></td>
