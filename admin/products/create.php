                ...
                <ul>
                    ...
                    <li class="menu-dropdown open">
                        ...
                        <ul class="dropdown-sidebar">
                             <li class="active"><a href="../products/create.php">Product Create</a></li>                        
                    ...
                    <div class="col-lg-12">
                        <div class="default-form">
                            <div class="form-title">
                                    <h3>Products Create Form</h3>
                                </div>
                            <div class="form-content">
                                 <?php
                    if(!isset($_SESSION['pomsg'])){
                      echo "<h5>Please add  Product here .</h5>";
                            ...
                            <form method="POST" action="store.php"  enctype="multipart/form-data">
                              ...
                              <div class="form-row">
                                ...
                                <div class="form-group form-line col-md-6">
                                  ...
                                  <input type="text" name="oldprices" class="form-control" id="inputPassword4" placeholder="Old Price" />
                                </div>
                                <div class="form-group form-line col-md-6">
                                  <label for="inputPassword5">Price</label>
                                  <input type="text" name="prices" class="form-control" id="inputPassword5" placeholder="Price" />
                                </div>
                              </div>
                              ...
                              <div class="form-row">
                                ...
                                <div class="form-group form-line col-md-6">
                                  ...
                                  <input type="text" name="authors" class="form-control" id="inputPassword4" placeholder="Author Name" />
                                </div>
                                <div class="form-group form-line col-md-6">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="description" rows="3" placeholder="Write Book Details" /></textarea>
                                  </div>
