...
function(a, b) {
    b.Filtering = b.Component.extend({
        ...
        setButton: function(a) {
            a ? this.$button.children(".fas").removeClass("fa-trash").addClass("fa-search") : this.$button.children(".fas").removeClass("fa-search").addClass("fa-trash")
        },
        find: function(a) {
        ...
        _onSearchButtonClicked: function(a) {
            ...
            if (c.hasClass("fa-trash")) b.clear();
            else {
                var d = b.$input.val();
        ...
        _onSearchColumnClicked: function(a) {
            ...
            null != b._filterTimeout && clearTimeout(b._filterTimeout), b._filterTimeout = setTimeout(function() {
                ...
                a.hasClass("fa-trash") && (a.removeClass("fa-trash").addClass("fa-search"), b.addFilter("search", b.$input.val()), b.filter())
            }, b.delay)
        },
    ...
    b.Sorting = b.Component.extend({
        ...
        destroy: function() {
            ...
            this.ft.raise("destroy.ft.paging").then(function() {
                a.ft.$el.off("click.footable", ".footable-sortable", a._onSortClicked), a.ft.$el.children("thead").children("tr.footable-header").children(".footable-sortable").removeClass("footable-sortable footable-asc footable-desc").find("span.fas").remove()
            })
        },
        predraw: function() {
            if (this.column) {
        ...
        draw: function() {
            if (this.column) {
                var a = this,
                    ...
                    c = a.column.$el;
                b.removeClass("footable-asc footable-desc").children(".fas").removeClass("fa-sort fa-sort-up fa-sort-down"), b.not(c).children(".fas").addClass("fa-sort"), c.addClass("DESC" == a.column.direction ? "footable-desc" : "footable-asc").children(".fas").addClass("DESC" == a.column.direction ? "fa-sort-down" : "fa-sort-up")
            }
        },
        sort: function(a, b) {
...
function(a, b) {
    b.Defaults.prototype.editing = {
        ...
        viewRow: function(a) {},
        showText: '<span class="fas fa-edit" aria-hidden="true"></span> Edit rows',
        hideText: "Cancel",
        addText: "New row",
        editText: '<span class="fas fa-edit" aria-hidden="true"></span>',
        deleteText: '<span class="fas fa-trash-alt" aria-hidden="true"></span>',
        viewText: '<span class="fas fa-i-cursor" aria-hidden="true"></span>',
        allowAdd: !0,
        allowEdit: !0,
        allowDelete: !0,
        allowView: !1,
