                    ...
                    <div class="col-lg-12">
                        <div class="default-form">
                            <div class="form-title">
                                    <h3>Authors Create Form</h3>
                                </div>
                            <div class="form-content">
                                 <?php
                    if(!isset($_SESSION['pomsg'])){
                      echo "<h5>Please add your Authors here .</h5>";
                            ...
                            <form method="POST" action="store.php"  enctype="multipart/form-data">
                              ...
                              <div class="form-row">
                                ...
                                <div class="form-group form-line col-md-6">
                                  ...
                                  <input type="text" name="name" class="form-control" id="inputPassword4" placeholder="Author Name" />
                                </div>
                                <div class="form-group form-line col-md-6">
