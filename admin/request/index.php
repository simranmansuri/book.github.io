                ...
                <ul>
                    ...
                    <li class="menu-dropdown open">
                        ...
                        <ul class="dropdown-sidebar">
                            ...
                            <li class="active"><a href="../request/index.php">Request  list</a></li>
                                ...
                                <table class="table ">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td scope="row"><?php echo $data['url']; ?></td>
                                      <td scope="row"><?php echo $data['email']; ?></td>
                                      <td scope="row"><?php echo $data['books']; ?></td>
