...
$objproductlist = new Products;

$allData = $objproductlist->index();
                ...
                <ul>
                    ...
                    <li class="menu-dropdown open">
                        ...
                        <ul class="dropdown-sidebar">
                            ...
                            <li class="active"><a href="../products/index.php">Product list</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="table-design">
                            <div class="table-header">
                                <h3>Bestseller All Data Table</h3>
                            </div>
                                ...
                                <table class="table ">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td scope="row"><?php echo $data['cat']; ?></td>
                                      <td scope="row"><?php echo $data['title']; ?></td>
                                      <td scope="row"><?php echo $data['oldprices']; ?></td>
                                      <td scope="row"><?php echo $data['prices']; ?></td>
                                      <td scope="row"><?php echo $data['authors']; ?></td>
                                      <td scope="row"><?php echo substr($data['description'], 0, 100); ?></td>
